...
---@param opt? Options
---@return Instance[]
local function launchObjects(objects, opt)
	assert(type(objects) == "table", "The first argument 'url' must be a string.")
	assert(type(opt) == "table" or opt == nil, "The second argument 'options' must be a table or nil.")
	...
	log("\n\n" .. utf8.char(0x1F680) .. " Launching model '" .. objects[1].Name .. ".rbxm'\n", options.verbose)
